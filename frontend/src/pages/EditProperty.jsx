...
import { 
  Upload, MapPin, Home, Bed, Bath, Users, DollarSign, 
...
export default function EditProperty() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Combinar imágenes existentes (no removidas) + nuevas
            ...
            <div>
              ...
              <div className="border-2 border-dashed rounded-lg p-6 text-center hover:border-primary transition">
                ...
                <label htmlFor="image-upload" className="cursor-pointer">
                  ...
                  <p className="text-xs text-gray-400 mt-1">JPG, PNG, GIF hasta 10MB</p>
                </label>
              </div>
